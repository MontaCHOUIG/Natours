...
var login = function login(email, password) {
  ...
  postData('http://127.0.0.1:3000/api/v1/users/login', {
    ...
    if (data.message === 'success') {
      (0, _alerts.showAlert)('success', 'LoggedIn successfuly !');
      window.setTimeout(function () {
        location.assign('/');
      }, 1500);
    } else if (data.status === 'fail') {
      (0, _alerts.showAlert)("error", "wrong input");
    }
  }).catch(function (err) {
...
},{"./alerts":"alerts.js"}],"maplibre.js":[function(require,module,exports) {
/* eslint-disable */
...
var map = new maplibregl.Map({
  container: 'map',
  // The ID of the div to render the map in
